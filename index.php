                ...
                <div class="container">
                    <div class="popular_header">
                        ...
                        <div class="timeline-item">
                            ...
                            <p class="date">7 – 31 Oktober 2024</p>
                        </div>
                
                        <div class="timeline-item">
                            <h3>Batas Pembayaran Tagihan</h3>
                            <p class="date">4 November 2024</p>
                        </div>
                
                        <div class="timeline-item">
                            <h3>Pembagian Hari Wisuda Per Fakultas</h3>
                            <p class="date">8 November 2024</p>
                        </div>
                
                        <div class="timeline-item">
                            <h3>Gladi Bersih</h3>
                            <p class="date">Kamis, 28 November 2024</p>
                        </div>
                
                        <div class="timeline-item">
                            <h3>Pelaksanaan Wisuda</h3>
                            <p class="date">30 November & 1 Desember 2024</p>
                        </div>
                    </div>
                </div>
            </section>
            <!-- Pengunguman section end -->
        </main>
